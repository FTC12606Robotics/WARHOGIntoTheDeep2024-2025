...
@TeleOp(name="WARHOGPushBotTeleOp", group="")
public class WARHOGPushBotTeleOp extends LinearOpMode {
    public WARHOGPushBotTeleOp() throws InterruptedException {}
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStarted() && !isStopRequested()) {
            ...
            try {
                ...
                // Swallow the possible exception, it should not happen as current Gamepad1/2 are being copied from valid Gamepads.
            }
